...
public class DriveEncoderLocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.0196;
    public static double STRAFE_TICKS_TO_INCHES = 0.0131;
    public static double TURN_TICKS_TO_RADIANS = 0.0016;
